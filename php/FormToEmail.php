...
$my_email = "info@erablierestgermain.ca";
...
$message = $message . PHP_EOL.PHP_EOL."-- ".PHP_EOL."Au plaisir de vous recevoir chez nous http://erablierestgermain.com/";
...
<div>
<center>
<b>Merci <?php if(isset($_REQUEST['name'])){print stripslashes($_REQUEST['name']);} ?></b>
<br>Nous avons bien reçu votre message
<p><a href="<?php print $continue; ?>">Retourner au site</a></p>
</center>
</div>
